            ...
            <div class="col-md-7 div-text">
                ...
                <ul class="list-style for-mul">
                    <li> <i class="fa-solid fa-circle-check"></i> <span>High-quality audiobook production with
                            professional narration.</span></li>
                    <li> <i class="fa-solid fa-circle-check"></i> <span>Immersive Audiobooks with Music, SFX &
                            More.</span></li>
                    <li> <i class="fa-solid fa-circle-check"></i> <span>You retain full rights and
                            royalties—subject to our non-exclusive publishing agreement.</span></li>
                    <li> <i class="fa-solid fa-circle-check"></i> <span>Distribution on top audiobook platforms
...
<section class="section s3 audio-com" data-aos="fade-in" data-aos-duration="1200">
    <div class="container">
        ...
        <div class="row ttff">
            <div class="col-md-3">
                <div class="com">
                    <img src="img/audioicon1.webp" alt="">
            ...
            <div class="col-md-3">
                <div class="com">
                    <img src="img/audioicon2.webp" alt="">
            ...
            <div class="col-md-3">
                <div class="com">
                    <img src="img/audioicon3.webp" alt="">
            ...
            <div class="col-md-3">
                <div class="com">
                    <img src="img/audioicon4.webp" alt="">
...
<div class="slider" data-aos="fade-in" data-aos-duration="1200">
    <div class="slide-track">
        ...
        <div class="slide">
            <img src="img/audi-2.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-3.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-4.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-5.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-6.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-7.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-8.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-9.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-10.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-11.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-12.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-13.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-14.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-15.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-16.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-17.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-18.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-19.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-20.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-21.webp" alt="">
        </div>
        <div class="slide">
            <img src="img/audi-23.webp" alt="">
        </div>
    </div>
</div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <div class="connect-img">
                    <img src="img/connect-img.webp" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="connect-audio publication-sec">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-4">
                <div class="connect-img">
                    <img src="img/publication-img.webp" alt="">
                </div>
            </div>
            <div class="col-md-8">
                <div class="connect-meta">
