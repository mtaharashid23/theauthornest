<?php include "include/header.php"; ?>
        <section class="section terms-heading" style="background-image:none !important;">
            <div class="container">
                ...
                <div class="para">
                    ...
                    <ul>
                        <li><i class="fa-solid fa-circle-check"></i>Contact our customer support team within 7 days
                            from the date you receive the final project deliverables or the project completion date,
                            whichever is applicable.</li>
                        <li><i class="fa-solid fa-circle-check"></i> Requests for revisions beyond this 7 -day period
                ...
                <div class="para">
                    ...
                    <ul>
                        <li><i class="fa-solid fa-circle-check"></i>Initiate contact with our customer support team
                            within 7 days of receiving the final project deliverables or upon reaching the project
                            completion date.</li>
                        <li><i class="fa-solid fa-circle-check"></i>Provide a comprehensive explanation detailing your
                            dissatisfaction, even if our Multiple Revisions Included policy has been utilized.</li>
                ...
                <div class="para">
                    ...
                    <ul>
                        <li><i class="fa-solid fa-circle-check"></i> Contact our customer support team either by calling
                            <a href="tel:+1 (323) 916 8484">+1 (323) 916 8484</a> or emailing <a
                                href="mailto:info@theauthornest.com"><span >info@theauthornest.com</span></a>
                            within
                            the
                            designated timeframe.</li>
                ...
                <div class="para">
                    ...
                    <p>While we provide plagiarism checks upon request, clients are encouraged to use additional tools
                        or services for comprehensive originality verification.</p>
                </div>
                <div class="para">
                ...
                <div class="para">
                    ...
                    <p>Under no circumstances shall The Author Nest or its associated entities be held liable for
                ...
                <div class="para">
                    ...
                    <p>The Author Nest provides all services and materials "as is," without any warranty, whether
                ...
                <div class="para">
                    ...
                    <p><b>Phone:</b> +1 (323) 916 8484 </p>
                    <p><b>Address:</b> 700 Wilshire Blvd Los Angeles, CA 90017, USA</p>
