        ...
        <div class="row align-items-center">
            <div class="col-md-7 div-text">
                ...
                <p>
                    ...
                    <br>
                    Our expert writing services support you at every stage—developing your idea, structuring your
                    manuscript, crafting the content, and guiding you toward publication—all while preserving your
...
<section class="portfolio">
    <div class="container">
        <div class="port-meta">
            <h2>Explore a Wide Range of Genres</h2>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row ttff">
            <div class="col-md-3">
                <div class="com write-com">
                    ...
                    <p>
                        Begin by sharing your story, vision, and goals. We’ll collaborate with you to outline the scope
                        and establish a project timeline tailored to your needs.
                    </p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="com write-com">
                    ...
                    <h4 class="mt-2">Chapter-by-Chapter Drafting</h4>
                    <p>
                        Our writers craft each chapter based on your input, setting the tone, voice, and structure of
                        your book—ensuring alignment with your vision at every step.
                    </p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="com write-com">
                    ...
                    <p>
                        After your review and approval of the drafts, we enhance your manuscript through detailed
                        editing and multiple rounds of proofreading to ensure clarity, consistency, and polish.
                    </p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="com write-com">
                    ...
                    <p>
                        With your final approval, we assist in publishing your book across 30+ major platforms,
                        expanding your reach to a worldwide audience.
                    </p>
                </div>
            </div>
        </div>
