            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-7 div-text">
                        <h1 class="heading">Book Marketing Services for <span class="marketing-page">Self-Published
                            </span> Authors.
                        </h1>
                        <p>Strategic, insights-driven services to help you build your author brand and improve book
                            visibility.</p>
                        <ul class="list-style for-mul">
                            <li> <i class="fa-solid fa-circle-check"></i> <span>Multi-Platform Marketing to Grow
                                    Audience Reach.</span></li>
                            <li> <i class="fa-solid fa-circle-check"></i> <span>Develop Custom Promotion Strategies for
                                    Increased
                                    visibility and sales.</span></li>
                            <li> <i class="fa-solid fa-circle-check"></i> <span>Author Brand Creation to Build Your
                                    Reputation.</span></li>
                            <li> <i class="fa-solid fa-circle-check"></i> <span>Author Retain Rights to Keep 100% of
                                    Book
                                    Royalties.</span></li>
                        </ul>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 div-text" data-aos="fade-left" data-aos-duration="2000">
                        ...
                        <ul class="list-style">
                            <li> <i class="fa-solid fa-circle-check"></i> <span>designed to increase your visibility
                                    among your target audience</span></li>
                        ...
                        <div class="banner-btns innder"> <a href="request-free-proposal.php"
                                class="talk-chat extra-ress-2"> Get
                                Started </a> <a href="tel:+1 (323) 916 8484" class="talk-phone exta-ress"><i
                                    class="fa-solid fa-phone"></i>+1
                                (323) 916 8484</a> </div>
                    </div>
                </div>
