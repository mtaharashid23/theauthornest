            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-7 div-text">
                        ...
                        <h2 class="starting-p">Price starting from <span class="">$4.95</span> per page.</h2>
                        <p style="font-size: 25px;">Proofread, Edited, Meticulously Proofread Content <span
                                style="color:#EF1012; font-weight:900;">In One Go!</span></p>
                        <ul class="list-style for-mul">
                            <li> <i class="fa-solid fa-circle-check"></i> <span>Proofread & Formatted to
                                    Perfection.</span></li>
                            <li> <i class="fa-solid fa-circle-check"></i> <span>Content Confidentiality
                                    Maintained.</span></li>
                            <li> <i class="fa-solid fa-circle-check"></i> <span>Plagiarism Check Included.</span></li>
                            <li> <i class="fa-solid fa-circle-check"></i> <span>Track Changes Visible.</span></li>
                        </ul>
