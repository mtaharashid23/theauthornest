            ...
            <div class="col-md-4">
                <div class="pack-1">
                    ...
                    <ul>
                        ...
                        <li>Editorial Review of Your Book</li>
                        <li>Author Website Design & Development (with Payment Integration)</li>
                        <li>SEO Optimized Web Content for Author Website</li>
                        <li>Keyword Research and Optimization of Author Website (for SEO Ranking)</li>
                        <li>Custom Logo Design for Author Website</li>
                        <li>Social Media Accounts Creation (Facebook, Instagram, Twitter X, LinkedIn, TikTok)
                        </li>
                        <li>90 Days Social Media Management (Facebook, Instagram, Twitter X, LinkedIn, TikTok)
                        </li>
                        <li>Global Book Announcement Press Release and Distribution</li>
                        <li>2 Power Blogs</li>
                        <li>2 Articles</li>
                        <li>Book Merchandise and Stationery Design</li>
                        <li>Weekly Reports to Monitor Progress</li>
                        <li>Dedicated Project Manager</li>
            ...
            <div class="col-md-4">
                <div class="pack-1">
                    ...
                    <ul>
                        <h5>What you get:</h5>
                        <li>Author Coaching and Strategy Sessions</li>
                        <li>Book Marketing Strategic Deck</li>
                        <li>Full Market Research Analysis</li>
                        <li>Target Market Segmentation</li>
                        <li>Book Pricing Strategy</li>
                        <li>Editorial Review of Your Book</li>
                        <li>Influencer Shout-outs</li>
                        <li>Podcast Interviews</li>
                        <li>Billboard Advertisement</li>
                        <li>Dedicated Author Website (SEO Optimized)</li>
                        <li>Social Media Marketing (Facebook, Instagram, Twitter X, LinkedIn, TikTok)</li>
                        <li>Book Merchandise and Stationery Design</li>
                        <li>Book Marketing Trailer</li>
                        <li>Author Experience Video</li>
                        <li>Book Promotion Video</li>
                        <li>Paid PRs</li>
                ...
                <div class="accordion">
                    ...
                    <div class="accordion__item">
                        <div class="accordion__item__header">
                            ...
                            <h4>What competitive advantages will I get from book marketing?</h4>
                        </div>
                        <div class="accordion__item__content" style="display:none;">
                            <p>Our book marketing services are designed to help you reach the right audience,
                                increase your book's visibility, and ultimately drive sales. We use data-driven
                                strategies, social media outreach, and email campaigns to ensure your book
                                stands out.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion">
                    ...
                    <div class="accordion__item">
                        <div class="accordion__item__header">
                            ...
                            <h4>What kind of marketing support do you provide?</h4>
                        </div>
                        <div class="accordion__item__content" style="display:none;">
                            <p>We offer a comprehensive marketing package, including social media promotion,
                                email campaigns, book reviews, and other strategies to increase your book’s
                                reach and build a loyal reader base.</p>
                        </div>
                    </div>
                    ...
                    <div class="accordion__item">
                        <div class="accordion__item__header">
                            ...
                            <h4>What if I don’t need all your services? Can I only pay for specific services?
                            </h4>
                        </div>
                        <div class="accordion__item__content" style="display:none;">
                            <p>
