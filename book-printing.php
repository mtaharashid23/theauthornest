    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-7 div-text">
                <h1 class="heading">We Provide Quality Book Printing Services for <span
                        class="printing-page">Your</span> <span class="printing-page">Masterpiece</span></h1>
                <ul class="list-style for-mul">
                    <li> <i class="fa-solid fa-circle-check"></i> <span>High-Quality Printing with Professional
                            Finish.</span></li>
                    <li> <i class="fa-solid fa-circle-check"></i> <span>Custom Book Formats and Sizes to Fit
                            Your Needs.</span></li>
                    <li> <i class="fa-solid fa-circle-check"></i> <span>We offer eco-friendly printing options
                            using recycled materials and environmentally conscious printing processes.</span>
                    </li>
                    <li> <i class="fa-solid fa-circle-check"></i> <span>Affordable bulk printing options
                            tailored to your order size. Get a custom quote based on your specific printing
                            needs.</span></li>
                    <li> <i class="fa-solid fa-circle-check"></i> <span>Fast Turnaround Time for Timely
                            Delivery.</span></li>
                    <li> <i class="fa-solid fa-circle-check"></i> <span>You retain 100% ownership of your
...
<section class="section s3 special-secc pt-5" data-aos="fade-in" data-aos-duration="1200">
    <div class="container printing-com">
        ...
        <div class="row ttff">
            <div class="col-md-3">
                <div class="com">
                    <img src="img/print-icon-1.webp" alt="">
                    <h4 class="mt-2">Quick Turnaround Times for Timely Delivery</h4>
                    <p>Fast turnaround times for typical orders, times may vary based on order size and
                        complexity, all done in our top-notch facility. Our
                        streamlined process ensures you meet your deadlines without compromising on quality.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="com">
                    <img src="img/print-icon-2.webp" alt="">
                    <h4 class="mt-2">Premium quality</h4>
                    <p>We use state-of-the-art printing technology to ensure premium quality at competitive
                        prices, customized for your specific needs.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="com">
                    <img src="img/print-icon-3.webp" alt="">
                    <h4 class="mt-2">Affordable pricing </h4>
                    <p>Get the best value for your book printing, available in every trim size. Whether
            ...
            <div class="col-md-3">
                <div class="com">
                    <img src="img/print-icon-4.webp" alt="">
...
<section class="section printing-vid">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="main-vid">
                    <div class="heading text-center">
                        <h2>Feel your story come alive in a printed book.</h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <video controls="" poster="img/poster.webp">
                    <source src="img/printing.mp4" type="video/mp4">
                </video>
            </div>
            <div class="col-md-6">
                <video controls="" poster="img/poster-2.webp">
                    <source src="img/printing-2.mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
